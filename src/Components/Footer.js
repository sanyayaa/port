        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
              ...
              <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase light:text-white">Resources</h2>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
              <span class="text-large text-gray-500 sm:text-center light:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Flowbite™</a>. All Rights Reserved.
              </span>
              <div class="flex mt-4 sm:justify-center sm:mt-0">
                  ...
                  <a href="#" class="text-gray-500 hover:text-gray-900 light:hover:text-white ms-5">
